...
import { Button } from '@/components/ui/button'
import { LogOut, Share2, Feather } from 'lucide-react'
...
const ProfilePage = () => {
    ...
    if (isLoading) {
        return <div className="min-h-screen flex items-center justify-center bg-[#fdfcfb] font-serif italic text-stone-400">Loading profile...</div>;
    }
        ...
        <div className="min-h-screen bg-[#fdfcfb] text-stone-900 selection:bg-orange-100 px-6 py-16 md:py-24">
            <div className="max-w-4xl mx-auto space-y-24">
                ...
                <header className="relative flex flex-col items-center text-center space-y-8 animate-in fade-in duration-1000">
                    ...
                    {/* Dynamic Avatar from Auth0 */}
                    <div className="relative group">
                        <div className="w-24 h-24 rounded-full bg-stone-100 border border-stone-200 flex items-center justify-center shadow-inner overflow-hidden">
                            {user?.picture ? (
                                <img src={user.picture} alt={user.name} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" />
                            ) : (
                                <span className="text-3xl font-serif italic text-stone-400">
                    ...
                    <div className="max-w-xl space-y-4">
                        <h1 className="text-4xl font-serif text-stone-800 tracking-tight">
                            {user?.name || "Anonymous Thinker"}
                        </h1>
                        <p className="text-stone-500 font-light leading-relaxed text-lg">
                            {user?.email} • Exploring the intersection of <span className="italic">AI, creativity</span>, and human systems.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <Button
                                ...
                                size="sm"
                                className="rounded-full px-6 bg-stone-900 text-white hover:bg-red-900 shadow-xl transition-all hover:-translate-y-0.5"
                            >
